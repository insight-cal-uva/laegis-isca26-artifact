...
int main()
{
    ...
    trainSetImporter.Read( "/shared/uvm_bench/non_UVM_benchmarks/logistic-regression/Dataset/train/train-first1000.arff" );
    ...
    // FILE * fp = fopen("/shared/uvm_bench/log/logreg.txt", "a");
	// if (fp == NULL) {
