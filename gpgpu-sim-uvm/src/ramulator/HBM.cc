...
map<string, enum HBM::Org> HBM::org_map = {
    ...
    {"HBM_1Gb_2rank", HBM::Org::HBM_1Gb_2rank},
    {"HBM_2Gb_2rank", HBM::Org::HBM_2Gb_2rank},
    {"HBM_4Gb_2rank", HBM::Org::HBM_4Gb_2rank},
};
...
map<string, enum HBM::Speed> HBM::speed_map = {
    ...
    {"HBM_V100", HBM::Speed::HBM_V100},
    {"HBM_A100", HBM::Speed::HBM_A100},
};

HBM::HBM(Org org, Speed speed, int channel_width, int prefetch_size)
...
{
    // unit of channel_width: bits.
    // unit of busW: bytes.
    assert(channel_width == 128 && "The size of data bus for HBM must be 128 bits");
    assert(prefetch_size == 2 && "The prefetch size for HBM must be 2");
    init_speed();
    init_prereq();
