...
map<string, enum GDDR5::Org> GDDR5::org_map = {
    {"GDDR5_512Mb_x16", GDDR5::Org::GDDR5_512Mb_x16}, 
    {"GDDR5_512Mb_x32", GDDR5::Org::GDDR5_512Mb_x32},
    {"GDDR5_1Gb_x16", GDDR5::Org::GDDR5_1Gb_x16}, 
    {"GDDR5_1Gb_x32", GDDR5::Org::GDDR5_1Gb_x32},
    {"GDDR5_2Gb_x16", GDDR5::Org::GDDR5_2Gb_x16}, 
    {"GDDR5_2Gb_x32", GDDR5::Org::GDDR5_2Gb_x32},
    {"GDDR5_4Gb_x16", GDDR5::Org::GDDR5_4Gb_x16}, 
    {"GDDR5_4Gb_x32", GDDR5::Org::GDDR5_4Gb_x32},
    {"GDDR5_8Gb_x16", GDDR5::Org::GDDR5_8Gb_x16}, 
    {"GDDR5_8Gb_x32", GDDR5::Org::GDDR5_8Gb_x32},
};

map<string, enum GDDR5::Speed> GDDR5::speed_map = {
    {"GDDR5_4000", GDDR5::Speed::GDDR5_4000}, 
    {"GDDR5_4500", GDDR5::Speed::GDDR5_4500},
    {"GDDR5_5000", GDDR5::Speed::GDDR5_5000}, 
    {"GDDR5_5500", GDDR5::Speed::GDDR5_5500},
    {"GDDR5_6000", GDDR5::Speed::GDDR5_6000}, 
    {"GDDR5_6500", GDDR5::Speed::GDDR5_6500},
...
// prefetch_size is in 8 B from config
// channel_width is in 64 bits from config
GDDR5::GDDR5(Org org, Speed speed, int channel_width, int prefetch_size)
: org_entry(org_table[int(org)]),
  speed_entry(speed_table[int(speed)]),
  read_latency(speed_entry.nCL + speed_entry.nBL),
  write_latency(speed_entry.nCWL + speed_entry.nBL),
...
// this will be called from ramulator
GDDR5::GDDR5(const string& org_str, const string& speed_str, int channel_width, int prefetch_size)
: GDDR5(org_map[org_str], speed_map[speed_str], channel_width, prefetch_size)
{}
